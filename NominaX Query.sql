...
-- Creaci�n de la base de datos NominaX
...
-- Creaci�n de la tabla EmpleadoEquipo
...
-- Creaci�n de la tabla PerfilProfesional
...
-- Creaci�n de la tabla TelefonoEmpleado
...
-- Creaci�n de la tabla DetalleNomina
...
-- Creaci�n de la tabla RegistroAsistencia
...
-- Creaci�n de la tabla IncidenciaAsistencia
...
-- Creaci�n de la tabla Justificacion
...
-- Creaci�n de la tabla Beneficio
...
-- Creaci�n de la tabla AsignacionBeneficio
...
('Recursos Humanos', 'Maneja las necesidades y pol�ticas de personal.', 'Edificio Principal'),
('Tecnolog�a de la Informaci�n', 'Soporte y desarrollo de sistemas inform�ticos.', 'Edificio de TI'),
('Finanzas', 'Gesti�n de las finanzas corporativas.', 'Edificio Administrativo'),
('Marketing', 'Promoci�n y estrategia de mercado.', 'Edificio Creativo'),
('Ventas', 'Gesti�n de ventas y relaciones con clientes.', 'Edificio Comercial');
GO
...
('Soporte T�cnico', 'Proporciona soporte t�cnico a la empresa.', 2),
('Contabilidad', 'Encargados de la contabilidad y finanzas.', 3),
('Social Media', 'Maneja las redes sociales y la presencia en l�nea.', 4),
('Ventas Internacionales', 'Gestiona las ventas fuera del pa�s.', 5);
GO
...
('Juan', 'P�rez', 'Calle Falsa 123', 'juan.perez@example.com', '1985-06-15', '2010-04-01', 'Casado', '123-45-6789'),
('Mar�a', 'L�pez', 'Avenida Siempre Viva 321', 'maria.lopez@example.com', '1990-09-25', '2015-08-23', 'Soltera', '987-65-4321'),
('Carlos', 'G�mez', 'Diagonal 456', 'carlos.gomez@example.com', '1975-12-03', '2005-05-17', 'Casado', '456-78-9123'),
('Ana', 'Mart�n', 'Paseo de la Reforma 789', 'ana.martin@example.com', '1988-03-22', '2013-03-15', 'Casada', '321-54-6789'),
('Pedro', 'N��ez', 'Ruta 27 654', 'pedro.nunez@example.com', '1980-11-11', '2000-01-01', 'Divorciado', '654-32-1987');
GO
...
(1, 'Gerente de RH', 'Gesti�n del departamento de recursos humanos.', '2010-04-01', NULL),
(2, 'Ingeniero de Sistemas', 'Desarrollo y mantenimiento de software.', '2015-08-23', NULL),
(3, 'Contador Principal', 'Supervisi�n de las operaciones financieras.', '2005-05-17', NULL),
(4, 'Community Manager', 'Gesti�n de las redes sociales y comunicaciones online.', '2013-03-15', NULL),
...
('Seguro de Salud', 'Cobertura m�dica completa.', 'Salud'),
...
('Capacitaci�n', 'Cursos y capacitaciones pagados por la empresa.', 'Educaci�n');
GO
...
-- Insertando datos en la tabla N�mina
...
(1, 'Tardanza', 'Llegada tarde por tr�fico', 'Aprobado'),
(2, 'Ausencia', 'Ausencia justificada por m�dico', 'Pendiente'),
(3, 'Ausencia', 'Ausencia sin justificar', 'Denegado'),
(4, 'Tardanza', 'Retraso por falla de transporte', 'Aprobado'),
(5, 'Ausencia', 'D�a personal', 'Aprobado');
GO
...
(1, 'Justificaci�n por tr�fico con reporte de tr�fico adjunto', NULL, 'Aprobado'),
(2, 'Justificaci�n m�dica con certificado adjunto', NULL, 'En revisi�n'),
(3, 'Sin documento justificativo', NULL, 'Denegado'),
(4, 'Documento de falla de transporte p�blico adjunto', NULL, 'Aprobado'),
(5, 'Solicitud previa de d�a personal', NULL, 'Aprobado');
GO

-- Insertando roles en la tabla Rol
INSERT INTO Rol (Nombre, Descripcion) VALUES
('Administrador', 'Acceso completo a todas las funciones de administraci�n y configuraci�n.'),
('Empleado', 'Acceso limitado a funciones espec�ficas de empleados como marcar asistencia y presentar justificaciones.');
GO
...
-- CONSULTAS MULTIPLES:
--Consulta para obtener el total pagado en n�minas por departamento en un periodo espec�fico.
...
--Consulta para obtener informaci�n detallada de los empleados y sus roles en los equipos
...
-- Procedimiento para insertar un nuevo empleado y asignarlo a un equipo autom�ticamente.
...
-- Procedimiento para actualizar el estado de una asignaci�n de beneficio.
...
-- TRIGGERS.
-- Disparador para actualizar el estado de la justificaci�n al cambiar el estado de la incidencia
...
-- Disparador para registrar autom�ticamente la fecha de fin de un perfil profesional al iniciar uno nuevo
...
-- Vista para detalles de n�mina y empleado.
...
-- Vista para acceso r�pido a las justificaciones y sus estados
